  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl px-6 py-20 sm:py-24 lg:py-28">
        <header className="mb-10 text-center text-black dark:text-white">
          <p className="mb-2 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-medium tracking-wide text-black/80 dark:text-white/90 backdrop-blur">
            <span className="inline-block h-2 w-2 animate-pulse rounded-full bg-green-500" />
            Available for new projects
          </p>
          <h2 className="mt-4 text-pretty text-4xl font-extrabold tracking-tight sm:text-5xl text-black dark:text-white">
            Let’s Connect
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-balance text-base text-black/70 dark:text-white/80">
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="group">
              <label htmlFor="contact-name" className="mb-2 block text-sm font-medium text-black/80 dark:text-white/90">
                Your name
              </label>
              <input
                id="contact-name"
                name="name"
                className="w-full rounded-xl border border-white/10 bg-white/15 px-4 py-3 text-base text-black dark:text-white placeholder-black/40 dark:placeholder-white/50 shadow-inner outline-none transition focus:border-brandPurple/60 focus:bg-white/20 focus:ring-4 focus:ring-brandPurple/20"
            ...
            <div className="group">
              <label htmlFor="contact-email" className="mb-2 block text-sm font-medium text-black/80 dark:text-white/90">
                Email address
              </label>
              <input
                id="contact-email"
          ...
          {/* Message */}
          <div className="group">
            <label htmlFor="contact-message" className="mb-2 block text-sm font-medium text-black/80 dark:text-white/90">
              Message
            </label>
            <textarea
              id="contact-message"
              name="message"
              rows={7}
              className="w-full resize-y rounded-xl border border-white/10 bg-white/15 px-4 py-3 text-base text-black dark:text-white placeholder-black/40 dark:placeholder-white/50 shadow-inner outline-none transition focus:border-brandPurple/60 focus:bg-white/20 focus:ring-4 focus:ring-brandPurple/20"
              placeholder="How can I help?"
              required
              disabled={state === 'sending'}
            />
            <p className="mt-2 text-xs text-black/50 dark:text-white/60">
          ...
          <div aria-live="polite" className="space-y-3">
            {state === 'sent' && (
              <p className="flex items-center gap-2 rounded-lg border border-emerald-400/30 bg-emerald-400/10 px-4 py-3 text-sm text-emerald-900 dark:text-emerald-200">
            ...
            {state === 'error' && (
              <p className="flex items-center gap-2 rounded-lg border border-rose-400/30 bg-rose-400/10 px-4 py-3 text-sm text-rose-900 dark:text-rose-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5">
