        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <GlassButton
              ...
              tone="ghost"
              textColor="#1f2937"
              className="w-[200px] h-12 gap-3 flex-shrink-0 self-center sm:self-auto"
              ariaLabel={ariaLabel}
            >
              ...
              <span className="flex flex-col leading-none text-left">
                <span className="text-[9px] tracking-wide">{preorder ? 'Pre-Order on the' : 'Download on the'}</span>
