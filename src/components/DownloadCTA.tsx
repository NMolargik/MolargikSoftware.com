  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        <div className="relative overflow-hidden rounded-3xl bg-gray-50 border border-gray-200 px-6 py-12 sm:px-10">
          {/* Accent line */}
          <div
            aria-hidden="true"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-[200px] h-12 rounded-[8px] border border-black bg-white hover:bg-gray-50 transition-colors flex-shrink-0 self-center sm:self-auto"
            ...
            >
              ...
              <span className="flex flex-col leading-none text-left">
                <span className="text-[9px] tracking-wide text-gray-800">{preorder ? 'Pre-Order on the' : 'Download on the'}</span>
